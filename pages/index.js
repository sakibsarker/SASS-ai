...
export default function Home() {
  ...
  return (
    <div className="w-screen h-screen overflow-hidden flex justify-center items-center relative bg-slate-800">
     
      <div className="relative z-10 text-white px-10 py-5 text-center max-w-screen-sm bg-slate-500/50 rounded backdrop-blur-sm">
        <Logo/>
